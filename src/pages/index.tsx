...
function HomePage() {
  return (
    <>
      <Head>
        <title>restaurant-software43</title>

        <meta
          name="description"
          content="Elevate Your Dining Experience with Restaurant-Software43: The Ultimate SaaS Solution for Streamlined Restaurant Management and Unmatched Efficiency"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Heading fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }}>
              ...
              >
                restaurant-software43
              </Text>
            </Heading>
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Elevate Your Dining Experience with Restaurant-Software43: The Ultimate SaaS Solution for Streamlined
